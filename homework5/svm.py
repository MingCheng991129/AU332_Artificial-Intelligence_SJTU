...
def svm(kernel, features, labels, features_test, labels_test):

    rf2 = SVC(kernel = kernel)
    ...
    print(kernel, '\t', accuracy_score(labels_test, predict))

    # write csv
    with open("all/predict_svm_" + kernel + ".csv", "w", newline='') as csvfile:
...
if __name__ == '__main__':
    ...
    kernel_lis = ['rbf', 'sigmoid', 'linear', 'poly']
    ...
    ## Here we take 'rbf' as example...
        svm('rbf', train_X, train_y, test_X, test_y)
